...
const ProjectCard = ({ card }) => {
  ...
  return (
    <a href={link} target="_blank">
      <div className='bg-container p-5 gap-5 rounded-2xl sm:w-[320px] w-[240px] h-full hover:bg-hover1 transition duration-300 ease-in-out flex flex-col justify-between'>  
        <div>
